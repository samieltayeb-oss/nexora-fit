...
const EXERCISE_GUIDES: Record<string, ExerciseFormGuide> = {
  ...
  'wall push-up': {
    name: 'Wall Push-Ups',
    title: 'Wall Push-Up Incline Guide',
    category: 'Upper Body & Shoulder Prep',
    gifSrc: '/artifacts/morning-challenge/wall_pushup_motion.gif',
    angleInfo: 'Elbows: 45° · Body: Straight Diagonal Incline',
    alignmentBadge: 'Glutes Squeezed · Flat Back',
    breathCue: 'Inhale Lean In · Exhale Press Wall Away',
    cadence: '2s Lower · 1s Press',
    focusCue: 'Stand arm-length from wall. Keep body in a straight plank as you bend elbows at 45° to bring chest near wall.',
    rules: [
      'Hands flat on wall at shoulder height and shoulder-width.',
      'Elbows track down and back at 45 degrees.',
      'Keep your core tight — do not bend at the waist.',
      'Press firmly through your palms to return to start.',
    ],
  },
  'mountain climber': {
    ...
    gifSrc: '/artifacts/morning-challenge/mountain_climbers_motion.gif',
  ...
  'plank': {
    ...
    gifSrc: '/artifacts/morning-challenge/plank_motion.gif',
  ...
  'wall sit': {
    ...
    gifSrc: '/artifacts/morning-challenge/wall_sit_motion.gif',
