...
const mockTelemetry: TelemetryData = {
  ...
  recentBodyMeasurements: [
    { id: 'b1', user_id: 'user_1', created_at: new Date(Date.now() - 14 * 24 * 60 * 60 * 1000).toISOString(), weight_kg: 83.5 },
    { id: 'b2', user_id: 'user_1', created_at: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString(), weight_kg: 82.2 },
    { id: 'b3', user_id: 'user_1', created_at: new Date().toISOString(), weight_kg: 81.0 }
  ],
  recentHealthLogs: [],
